...
class MIMEMessage
  ...
  class Headers < Hash
    ...
    # SHWARE - RUBY 1.9.2 doesn't like .each on a String 
    #          split str into a_str
    def parse(str)
      header_cache = nil
      a_str = str.split("\n")
      a_str.each do |line|
  ...
  class Part
    ...
    # SHWARE - removed the /s option from the regex - it was throwing encoding mismatch errors
    def parse(str)
